        ...
        <div className="w-full px-4 mx-auto">
          ...
          <section className="pl-10 pr-20 pb-[100px] flex flex-col items-center">
            <div className="max-w-[900px] w-full">
              ...
              <p className="mb-4 text-xl">그렇다면 용인 수지구만 초진 대기일이 길었던 걸까? SBS 본사가 위치한 오목교역 부근에서 정신과 초진 예약을 시도해보았다. 데이터 상 양천구는 ‘당일 접수’가 가능해 접근성이 높은 편으로 보였기 때문이다.</p>
              <p className="mb-4 text-xl">하지만 현실은 달랐다.</p>
              <figure className="flex flex-col items-center mb-4">
                <img src="/images/delay2.png" className=""/>
              </figure>
