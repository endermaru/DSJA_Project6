    ...
    <div className={`${pretendard.variable} text-4xl font-medium text-black relative bg-white`}>
        ...
        <div className="w-full px-4 mx-auto">
          ...
          <section className="pl-10 pr-20 pb-[100px] flex flex-col items-center">
            ...
            <div className="mt-4 max-w-[900px] w-full">
              <p className="mb-10 text-xl text-justify">의료 현장에서도 이러한 변화를 체감하고 있다. 강지인 세브란스병원 정신과 교수는 “정신질환에 대한 사회적 편견이 줄어들면서 정신과의 문턱이 낮아지고 있다”며 “특히 20~30대를 중심으로 ‘정신과에 가도 된다’는 인식이 자리 잡고 있다”고 설명했다.</p>
              <p className="mb-4 text-xl text-justify">최근 ‘김하늘 양 사건’에서도 우울증에 대한 대중의 인식 변화를 엿볼 수 있었다. SBS, KBS, MBC, JTBC 방송사의 유튜브 조회수 상위 4개 영상에서 상위 노출 댓글 50개씩, 총 800개를 수집, 분석해보았다. </p>
            </div>
            <motion.div
                    variants={fadeInVariants}
                    initial="hidden"
            ...
            <div className="mt-4 max-w-[900px] w-full">
              <p className="mb-4 text-xl text-justify">워드클라우드 분석 결과, 우울증, 정신, 심신 등의 키워드가 상대적으로 두드러지는 것을 확인할 수 있었다. 사건의 원인 또는 비난 대상으로 우울증이 지목됐던 것일까?</p>
              ...
              <p className="mb-4 text-xl text-justify">그러나 댓글들을 하나씩 살펴봤을 때, 그 추측과는 상이한 모습을 볼 수 있었다. 우울증이 언급된 댓글의 44.9%가 ‘우울증에 걸렸다고 해서 범죄를 저지르는 것은 아니다’라며 정신질환에 대한 낙인을 경계했다.</p>
              <figure className="flex flex-col items-center mb-4">
              ...
              <p className="mb-4 text-xl text-justify">이처럼 정신질환에 대한 인식은 개선됐지만, 실제 정신과 진료의 접근성은 여전히 과제로 남아 있다.</p>
            </div>
          </section>
          <section className="pl-10 pr-20 pb-[100px] flex flex-col items-center">
            <div className="max-w-[900px] w-full">
              ...
              <p className="mb-4 text-xl text-justify">경기도 용인시 수지구에 거주하는 A씨는 상담 치료가 필요하다 생각해 정신과 진료를 받아보기로 결심했다. 하지만 예약 과정에서 난관에 부딪혔다. 어렵게 용기를 내 병원에 전화를 걸었지만, 초진 진료까지 2~3개월을 기다려야 한다는 답변을 받았다.</p>
              <p className="mb-4 text-xl text-justify"> 초진이었던 A씨는 여러 선택지 중 의원을 우선 고려했다. 그 이유에 대해 “기침을 하는 게 편도염 때문인지, 목감기 때문인지는 병원에 가야 알 수 있는 것처럼, 정신과에 가서 내 상태를 진단 받고 싶었다.”고 말했다. 이에 따라 취재진은 개원의 정신과를 조사했다.</p>
              <p className="mb-4 text-xl text-justify">우선 A씨가 거주 중인 용인 수지구의 정신과를 전수조사해 보았다. 전화 결과, 11곳 중 당일 접수할 수 있는 곳은 없었고, 1일 이상 7일 이하는 3곳, 8일 이상 15일 이하는 1곳, 16일 이상 30일 이하는 3곳, 30일 초과는 4곳이었다.  취재진이 A 씨의 입장에서 병원 리뷰를 분석한 결과, 예약이 가장 빠른 병원은 상담 없이 약 처방을 하는 곳이었고, 예약이 가장 오래 걸리는 곳은 재진 환자들이 너무 많아 초진 환자는 무려 101일, 즉 3달 넘게 기다려야 했다. </p>
              <figure className="flex flex-col items-center mb-4">
                <motion.div
                        variants={fadeInVariants}
                        initial="hidden"
              ...
              <p className="mb-4 text-xl text-justify">전국적으로도 상황이 비슷할까? 전국 정신과 의원을 지역 별로 무작위로 선정해 180여 곳에 전화해 본 결과, 응답한 병원 중 절반 이상은 당일 접수가 가능했다. 그러나 1달부터 3달까지 대기해야 하는 곳도 있었으며 전주 덕진구의 한 의원은 6달을 기다려야 한다고 했다.</p>
              ...
              <p className="mb-4 text-xl text-justify mt-10">시설 부족으로 인해 초진 대기 기간의 편차가 생기는 것일까? 이에 본지는 시군구별 요양기관당 평균 환자 수 분포를 분석해봤다.</p>
              ...
              <p className="mb-4 text-xl mt-10 text-justify">그렇다면 용인 수지구만 초진 대기일이 길었던 걸까? SBS 본사가 위치한 오목교역 부근에서 정신과 초진 예약을 시도해보았다. 데이터 상 양천구는 ‘당일 접수’가 가능해 접근성이 높은 편으로 보였기 때문이다.</p>
              <p className="mb-4 text-xl mb-10 text-justify">하지만 현실은 달랐다.</p>
              <figure className="flex flex-col items-center mb-4">
                <motion.div
                          variants={fadeInVariants}
                          initial="hidden"
              ...
              <p className="mb-4 text-xl text-justify">당일에 초진을 잡을 수 있던 곳은 상담 치료보단 약 처방 중심이거나 과잉 진료가 의심되는 병원이 적지 않은 비중을 차지했다. 그래서 이를 제외하고 다른 의원들에 전화를 걸었다. 그러나 한 의원은 예약이 이미 가득 차 있어 3~4달을 기다려야 했고, 또 다른 의원은 초진 비용이 10만 원에 달했다. 초진 시 진행되는 검사 여부 및 종류에 따라 병원 별 금액 편차가 컸다.</p>
              <p className="mb-4 text-xl text-justify">이처럼 리뷰가 양호한 의원들은 대부분 대기 시간이 길거나 비용이 높아 쉽게 접근하기 어려웠다. 정신과 상담은 내과나 정형외과 등 다른 진료 과목보다 일상에서의 인지적 거리가 멀다. 따라서 초진 환자들은 후기에 더욱 의존할 수밖에 없고, 이에 따라 세심하게 의원을 고르다 보면 자연스럽게 특정 의원으로 사람이 몰려 초진까지 몇 달을 기다려야 하는 상황이 생긴 것으로 추측할 수 있다. </p>
            </div>
          </section>
          ...
          <section className="pl-10 pr-20 pb-[30px] flex flex-col items-center">
            <div className="max-w-[900px] w-full">
              ...
              <p className="mb-4 text-xl mb-10 text-justify">정신과 진료의 장벽을 더 알아보기 위해, 정신과 진료를 희망하는 사람들이 이용하는 지식인(Q&A 커뮤니티)을 조사했다. 분석 결과, 정신과 관련 질문에서 ‘치료’와 ‘병원’이 높은 비중을 차지했다. 이는 많은 이들이 진료 기관 선택에서 어려움을 겪고 있음을 보여준다.</p>
            </div>
            <motion.div
                          variants={fadeInVariants}
                          initial="hidden"
                          ...
                          viewport={{ once: true, amount: 0.2 }}
                        >
              <div className="w-full flex flex-row justify-center gap-1 items-start mb-4">
            ...
            <Tabs defaultValue="tab1" className="w-full max-w-[900px] bg-gray-200 p-5 border rounded-lg">
              ...
              <TabsContent value="tab1">
                <section className="bg-white rounded-lg p-8">
                  ...
                  <p className="mb-4 text-xl text-justify items-start">
              ...
              <TabsContent value="tab2">
                <section className="p-6 bg-white rounded-lg p-8">
                  ...
                  <p className="mb-4 text-xl text-justify items-start pb-5">
          ...
          <section className="pl-10 pr-20 pb-[30px] flex flex-col items-center">
            <div className="max-w-[900px] w-full">
              ...
              <p className="mb-4 text-xl mb-10 text-justify">정신과 의원은 주로 약 처방을 병행하며 건강보험 적용을 받을 수 있다. 반면 심리상담센터는 건강보험 혜택이 없어 정신과에 비해 비용이 많이 드는 편이었다. 의원은 건강보험 혜택을 받을 경우 건강보험 진료기록이 남지만, 이는 제3자에 의해 열람이 불가하여 취업 등에서 불이익은 없다. 정신건강복지센터(보건소)는 무료 상담을 받을 수 있는 장점이 있었으나, 구 별로 한 개씩만 존재해 개인에 따라 방문 접근성이 떨어질 수 있다는 점이 있었다.</p>
            </div>
          </section>
        </div>
      </div>
      <section className="pl-10 pr-20 pb-[30px] flex flex-col items-center">
        <div className="max-w-[900px] w-full">
          ...
          <p className="mb-4 text-xl mb-10 text-justify">
          ...
          <p className="mb-4 mx-20 text-xl mb-10 text-justify italic">
